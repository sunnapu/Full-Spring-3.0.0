...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.cgi.service.impl.PasswordTokenManager#generateRecoveryToken(com.cgi.model.User)
     */
    @Override
    ...
    /**
     * @see com.cgi.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.cgi.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.cgi.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
