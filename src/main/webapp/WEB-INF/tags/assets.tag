...
<c:choose>
    ...
    <c:when test="${sessionScope.debugAssets}">
        ...
        <script type="text/javascript" src="${base}/webjars/jquery/1.9.1/jquery.min.js"></script>
        <script type="text/javascript" src="${base}/webjars/bootstrap/3.1.1/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="${base}/webjars/jquery-cookie/1.4.0/jquery.cookie.js"></script>
